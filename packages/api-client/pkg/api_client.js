...
export class WasmApiClient {
    ...
    set_auth_token(token) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.wasmapiclient_set_auth_token(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @returns {string}
     */
    get_auth_token() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.wasmapiclient_get_auth_token(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     */
    get_gateway_health() {
        const ret = wasm.wasmapiclient_get_gateway_health(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {string} email
    ...
    login(email, password) {
        ...
        const ret = wasm.wasmapiclient_login(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        return ret;
    }
    /**
    ...
    register(first_name, last_name, email, password) {
        ...
        const ret = wasm.wasmapiclient_register(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        return ret;
    }
    /**
     * @param {string} email
    ...
    resend_confirm_email(email) {
        const ptr0 = passStringToWasm0(email, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmapiclient_resend_confirm_email(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
    ...
    update_password(old_password, new_password) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmapiclient_update_password(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        return ret;
    }
    /**
    ...
    update_email(new_email) {
        const ptr0 = passStringToWasm0(new_email, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmapiclient_update_email(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     * @param {string} email
    ...
    forget_password(email) {
        const ptr0 = passStringToWasm0(email, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmapiclient_forget_password(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     * @param {string} token
    ...
    reset_password(token, new_password) {
        ...
        const ptr1 = passStringToWasm0(new_password, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmapiclient_reset_password(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        return ret;
    }
    /**
     * @returns {Promise<any>}
     */
    delete_account() {
        const ret = wasm.wasmapiclient_delete_account(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {Promise<any>}
     */
    logout() {
        const ret = wasm.wasmapiclient_logout(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {Promise<any>}
    ...
    get_local_user_profile() {
        const ret = wasm.wasmapiclient_get_local_user_profile(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {any} profile
    ...
    update_local_user_profile(profile) {
        const ret = wasm.wasmapiclient_update_local_user_profile(this.__wbg_ptr, profile);
        return ret;
    }
    /**
     * @param {string} name
    ...
    upload_profile_picture(name, mime, buffer) {
        ...
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.wasmapiclient_upload_profile_picture(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
        return ret;
    }
    /**
     * @returns {Promise<any>}
    ...
    delete_profile_picture() {
        const ret = wasm.wasmapiclient_delete_profile_picture(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {string} name
    ...
    upload_cover_photo(name, mime, buffer) {
        ...
        const ptr2 = passArray8ToWasm0(buffer, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.wasmapiclient_upload_cover_photo(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
        return ret;
    }
    /**
     * @returns {Promise<any>}
     */
    delete_cover_photo() {
        const ret = wasm.wasmapiclient_delete_cover_photo(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {string} name
    ...
    upload_resume(name, mime, buffer) {
        ...
        const ptr2 = passArray8ToWasm0(buffer, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.wasmapiclient_upload_resume(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
        return ret;
    }
    /**
     * @returns {Promise<any>}
     */
    delete_resume() {
        const ret = wasm.wasmapiclient_delete_resume(this.__wbg_ptr);
        return ret;
    }
    /**
    ...
    get_notifications(page) {
        const ret = wasm.wasmapiclient_get_notifications(this.__wbg_ptr, isLikeNone(page) ? 0x100000001 : (page) >> 0);
        return ret;
    }
    /**
    ...
    mark_notification_as_read(notification_id) {
        const ret = wasm.wasmapiclient_mark_notification_as_read(this.__wbg_ptr, notification_id);
        return ret;
    }
    /**
     * @param {number} notification_id
    ...
    mark_notification_as_unread(notification_id) {
        const ret = wasm.wasmapiclient_mark_notification_as_unread(this.__wbg_ptr, notification_id);
        return ret;
    }
    /**
     * @param {number} notification_id
    ...
    delete_notification(notification_id) {
        const ret = wasm.wasmapiclient_delete_notification(this.__wbg_ptr, notification_id);
        return ret;
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper777 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 261, __wbg_adapter_49);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('api_client_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
