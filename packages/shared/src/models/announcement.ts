 ...
 * @property {Array<string>} image_urls - URLs to the image in the announcement post (not optional - must be an empty list if there are no images)
 ...
 * @property {string} video_url - URL to the announcement video (optional)
