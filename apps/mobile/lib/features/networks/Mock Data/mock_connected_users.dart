...
class MockConnectedUsers {
  ...
  static final List<ConnectedUser> _connectedUsers = [
    ConnectedUser(
      ...
      first_name: 'John',
      last_name: 'Doe',
      profile_image_url: 'assets/logo.jpg',
      headline: 'Software Engineer at Google',
      connected_at: DateTime.now().subtract(const Duration(days: 30)),
    ),
    ConnectedUser(
      user_id: '2',
      first_name: 'Jane',
      ...
      connected_at: DateTime.now().subtract(const Duration(days: 25)),
    ),
    ...
    return _connectedUsers.firstWhere(
      ...
      orElse:
          () => ConnectedUser(
            ...
            first_name: 'Unknown',
            last_name: 'User',
            profile_image_url: 'assets/EmptyUser.png',
  ...
  static List<ConnectedUser> getMutualConnections(
    ...
    return [
      ConnectedUser(
        ...
        last_name: 'Ronaldo',
        profile_image_url: 'assets/logo.jpg',
        headline: 'Data Analyst at Amazon',
        connected_at: DateTime.now().subtract(const Duration(days: 45)),
      ),
      ConnectedUser(
        user_id: '6',
        first_name: 'David',
        ...
        connected_at: DateTime.now().subtract(const Duration(days: 50)),
      ),
    ];
  }
