...
import 'package:ascend_app/features/networks/pages/past_company_searching.dart';
            ...
            return OutlinedButton(
              onPressed: () {
                ...
                if (!isPressed) {
                  ...
                  context.read<SearchFiltersBloc>().add(
                    SearchFiltersRemove(key: 'pastCompanies', value: company),
                  );
                }
              },
...
void showpastCompanyModal(BuildContext context) {
          ...
          children: [
            ...
            Row(
              children: [
                ...
                state.filters.pastCompanies.isNotEmpty
                    ? TextButton(
                      onPressed: () {
                        context.read<SearchFiltersBloc>().add(
                          SearchFiltersReset(),
      ...
      Expanded(
        child: ListView(
          ...
          children: [
            ...
            if (state.filters.pastCompanies.isNotEmpty)
              buildCompanySelectedButtons(context, state.filters.pastCompanies),
          ],
        ),
      ),
      //Show Results Button
...
void _navigateToCompanySearch(
  ...
  // Close the past modal first to prevent memory stacking
      ...
      MaterialPageRoute(
        builder:
            (newContext) => MultiBlocProvider(
              ...
              child: const PastCompaniesSearching(),
            ),
      ),
    );
  });
