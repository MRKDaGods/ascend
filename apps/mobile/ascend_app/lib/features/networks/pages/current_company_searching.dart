...
class CurrentCompaniesSearching extends StatefulWidget {
  const CurrentCompaniesSearching({super.key});

  @override
  State<CurrentCompaniesSearching> createState() =>
      _CurrentCompaniesSearchingState();
}

class _CurrentCompaniesSearchingState extends State<CurrentCompaniesSearching> {
            ...
            onTap: () {
              try {
                ...
                searchFiltersBloc.add(
                  SearchFiltersUpdate(key: 'currentCompanies', value: company),
                );
                Navigator.pop(context);
                Future.delayed(const Duration(milliseconds: 0), () {
                  showCurrentCompanyModal(context);
