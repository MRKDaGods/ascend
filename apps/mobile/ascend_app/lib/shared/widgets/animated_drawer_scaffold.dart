...
class AnimatedDrawerScaffold extends StatelessWidget {
  final Widget child;
  ...
  Widget build(BuildContext context) {
    return _AnimatedDrawerController(
...
class _AnimatedDrawerController extends StatefulWidget {
  final Widget child;
  final Duration openDuration;
  final Duration closeDuration;
  final Curve openCurve;
  ...
  const _AnimatedDrawerController({
    Key? key,
    required this.child,
  ...
  @override
  _AnimatedDrawerControllerState createState() => _AnimatedDrawerControllerState();
}

class _AnimatedDrawerControllerState extends State<_AnimatedDrawerController> with SingleTickerProviderStateMixin {
