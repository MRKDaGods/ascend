...
void main() {
  group('JoinAscend Page Tests', () {
    testWidgets('renders JoinAscend page correctly', (
      WidgetTester tester,
    ) async {
      // Arrange
      await tester.pumpWidget(const MaterialApp(home: JoinAscend()));
    ...
    testWidgets('validates email input', (WidgetTester tester) async {
      ...
      await tester.enterText(
        find.byKey(const Key('Join_email')),
        'invalid-email',
      );
    ...
    testWidgets('navigates to SignInPage on "Sign In" button tap', (
      WidgetTester tester,
    ) async {
      // Arrange
      await tester.pumpWidget(const MaterialApp(home: JoinAscend()));
