    ...
    return (
      <Grid id="company-cards-grid" container spacing={3} mt={2}>
        {companyList.map((company: any) => (
          <Grid id={`company-card-grid-${company.company_id}`} item xs={12} sm={6} md={4} lg={3} key={company.company_id}>
            <Card
            ...
            >
              ...
              <CardContent id={`company-card-content-${company.company_id}`}>
                <Typography id={`company-card-title-${company.company_id}`} variant="h6" noWrap>
                  {company.company_name}
                </Typography>
                <Typography id={`company-card-industry-${company.company_id}`} variant="body2" color="text.secondary" noWrap>
                  {company.industry}
                </Typography>
                <Typography id={`company-card-location-${company.company_id}`} variant="body2" color="text.secondary" noWrap>
                  {company.location}
                </Typography>
                <Typography
