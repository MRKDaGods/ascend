...
interface DiscardCompanyPostDialogProps {
  open: boolean;
  onClose: () => void;
  onDiscard: () => void;
  onSave: () => void;
...
const DiscardCompanyPostDialog: React.FC<DiscardCompanyPostDialogProps> = ({ open, onClose, onDiscard, onSave }) => {
  return (
...
export default DiscardCompanyPostDialog;
