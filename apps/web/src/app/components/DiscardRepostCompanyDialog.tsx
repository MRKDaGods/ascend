...
interface DiscardRepostCompanyDialogProps {
  open: boolean;
  onClose: () => void;
  onDiscard: () => void;
  onSave: () => void;
...
const DiscardRepostCompanyDialog: React.FC<DiscardRepostCompanyDialogProps> = ({ open, onClose, onDiscard }) => {
  return (
...
export default DiscardRepostCompanyDialog;
